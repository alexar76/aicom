...
- GitHub-house deliverable: English `README.md` with badge row + hero SVG (`docs/gallery/hero.svg`) and 2–4 stills when the page has a visual UI; locale twin (`README.<code>.md`) when copy is not English; a smoke test. Docs stay bilingual even though the landing UI is monolingual.
