...
AiProvider.aimarket: AiProviderPreset(
  label: 'AI Market',
  baseUrl: 'https://modelmarket.dev',  // default hub
...
Hub returns: {channel_id, invoice_url: "aimarket://pay?invoice=inv_abc123"}
         │
         ▼
Koach opens browser: https://modelmarket.dev/pay?invoice=inv_abc123
         │
         ▼
...
"aiProviderAimarketSetupHint": "AI Market: modelmarket.dev — wallet-based, no API key. Top up credits first.",
