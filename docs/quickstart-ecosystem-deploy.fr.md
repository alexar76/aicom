# Déployer tout l'écosystème — démarrage rapide from scratch
...
- **Enregistrements DNS A/AAAA** pointant vers l'hôte que vous utilisez (palier 3+) :
  ...
  - `oracles.modelmarket.dev` → **hôte des oracles** (`78.17.126.214`), directement (sans proxy factory)
...
Les oracles s'exécutent sur une **machine séparée** (`78.17.126.214`). **`deploy_ecosystem.sh` NE
...
### 6.1 Sur l'hôte Platon (`78.17.126.214`, en root)
...
boucle économique sont documentés dans [`oracles/docs/en.md`](../oracles/docs/en.md).
...
- [`oracles/docs/en.md`](../oracles/docs/en.md) — les dix-sept oracles et la boucle économique
- [Documentation du SDK AIMarket](../aimarket-sdks/docs/en.md) · [Agent Python](../aimarket-agent/docs/en.md) — consommer le Hub
