...
> Guide illustré : [USER_GUIDE.md](./USER_GUIDE.md) · English: [FAQ.md](./FAQ.md) · Español: [FAQ.es.md](./FAQ.es.md) · Русский: [FAQ.ru.md](./FAQ.ru.md) · **Français** · 中文: [FAQ.zh.md](./FAQ.zh.md)
...
Cela dépend de l'état et de la politique du worker. Voir admin-guide et l'API. Souvent il est plus simple de le laisser `FAILED` / not pursuing que de le supprimer physiquement.
...
| Niveau | Doc |
|---------|----------|
| Opérateur UI | [USER_GUIDE.md](./USER_GUIDE.md), cette FAQ · RU: [USER_GUIDE.ru.md](./USER_GUIDE.ru.md) · ES: [USER_GUIDE.es.md](./USER_GUIDE.es.md) |
