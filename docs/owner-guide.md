...
**Public demo** (`AIFACTORY_DEMO_READONLY=1` on e.g. magic-ai-factory.com): backup, restore, settings save, admin password change, and user management are **blocked** so visitors cannot corrupt the shared passwordless demo or catalog products.
