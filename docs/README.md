...
> **Ecosystem knowledge base (start here):** [`ecosystem/knowledge-base.md`](./ecosystem/knowledge-base.md) · [RU](./ecosystem/knowledge-base-ru.md) · [ES](./ecosystem/knowledge-base-es.md) · [whitepaper](./ecosystem/whitepaper/)
>
...
| Scope | Languages |
|-------|-----------|
| **Ecosystem whitepaper** (ideology, all components, admin) | **EN** · [RU](./ecosystem/whitepaper/ru.md) · [ES](./ecosystem/whitepaper/es.md) |
...
| **Factory operator** | EN · [RU](./USER_GUIDE.ru.md) · [ES](./USER_GUIDE.es.md) |
...
- **[`metis-integration.md`](./metis-integration.md)** — **Metis ⇄ AI-Factory**: optional confidence gate on high-stakes stages (EN · [RU](./metis-integration.ru.md) · [ES](./metis-integration.es.md)).
- **[`ecosystem/whitepaper/`](./ecosystem/whitepaper/)** — full white book (EN/RU/ES): ideology, architecture, every component, money/trust flows, Base mainnet demos, admin deploy, config tables, roadmap.
