...
| Orchestration course | https://github.com/alexar76/orchestration-course | https://alexar76.github.io/orchestration-course/ |
...
- [Protocol spec](https://github.com/alexar76/aimarket-protocol)
- [Ecosystem overview](https://alexar76.github.io/aicom/)
```
...
| awesome-mcp-servers | `aimarket-mcp-packager` via `aimarket-plugins` | Whole hub unless you add a dedicated MCP bridge repo |
