        ...
        "ru": [
            {
                ...
                "paragraphs": [
                    ...
                    "Покупатель не передаёт произвольные URL (защита от SSRF). Оператор задаёт якоря в env — Берлин Open-Meteo, NYC NWS, прилив Battery, углерод UK, землетрясения USGS — плюс **глобальный Open-Meteo mesh** (Оттава, Нью-Дели, Токио…). Симуляторы демо-площадки честно остаются **SIM** (нет `source`).",
                ...
                "cards": [
                    ...
                    {"icon": "🧪", "title": "SIM-площадка", "body": "Учебная физика у Берна. Нет source → на ATLAS всегда SIM.", "color": "gold"},
                ],
            },
            {
                ...
                "cards": [
                    {"icon": "🗺️", "title": "LIVE vs SIM", "body": "LIVE требует provenance. SIM — практика на демо-площадке. Не путай.", "color": "cyan"},
