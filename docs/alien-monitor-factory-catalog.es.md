...
UNI levanta Anvil local **y** consulta Factory / Hub / Mesh / Prometheus en vivo. Sincronización en el arranque y cada ~60 s (`ALIEN_FACTORY_SYNC_TICKS`, default 40 ticks).
