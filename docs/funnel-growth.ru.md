...
> **English:** [funnel-growth.md](./funnel-growth.md) · **Русский** · **Español:** [funnel-growth.es.md](./funnel-growth.es.md) · **Français:** [funnel-growth.fr.md](./funnel-growth.fr.md) · **中文:** [funnel-growth.zh.md](./funnel-growth.zh.md)
...
| Статус | `/status/{token}` | Опрос состояния продукта (15 с) |
| Метрики доверия | `TrustMetricsStrip` на главной | Shipped / in pipeline / leads |
...
Или внедрите скрипт через **Admin → Settings → published site head HTML**.
...
`tests/test_funnel_growth.py` — автозапуск пайплайна для лидов, публичный статус, стадии аналитики.
