...
![Aperçu du tableau de bord en français](screenshots/dashboard.svg)
...
4. Conserver la clé `ask_...` ; le checkout permet sa récupération pendant 48 heures.
5. Connecter une identité d’actor et créer la première Memory Unit.

Guide complet : [USER_GUIDE.md](USER_GUIDE.md). Cas pratiques : [USE_CASES.md](USE_CASES.md). Termes : [GLOSSARY.md](GLOSSARY.md). Trial : [TRIAL.md](TRIAL.md). Fédération KOVA : [KOVA_CAPABILITIES.md](KOVA_CAPABILITIES.md).

Pour Expert Memory Market : [guide acheteur, éditeur et intégrateur](MARKET_GUIDE.md) et [cas d’usage du marché](MARKET_USE_CASES.md).

Pour l’intégration API et la publication de capabilities : [guide développeur](DEVELOPER_GUIDE.md).
