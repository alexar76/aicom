...
> Guía ilustrada: [USER_GUIDE.es.md](./USER_GUIDE.es.md) · English: [FAQ.md](./FAQ.md) · Русский: [FAQ.ru.md](./FAQ.ru.md) · Français: [FAQ.fr.md](./FAQ.fr.md) · 中文: [FAQ.zh.md](./FAQ.zh.md)
...
**Sin contraseña:** usuario `admin`, botón **Enter admin demo** (el campo de contraseña está oculto). `AIFACTORY_DEMO_READONLY=1` bloquea operaciones destructivas en admin. Ver [security.md § Public demo](./security.md#public-demo-mode-aifactory_demo_readonly1).
...
Depende del estado y la política del worker. Ver admin-guide y API. A menudo es más simple dejar `FAILED` / sin continuar con él que borrar físicamente.
...
| Dueño de la instancia | [owner-guide.md](./owner-guide.md) |
