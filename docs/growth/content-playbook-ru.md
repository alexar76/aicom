...
Инструкция для коллег: что писать на лендингах, в README и доках. Плейбук для агентов и людей, которые трогают репо экосистемы AICOM.
...
## 2. Две двери — два типа людей

Не один generic «join community». Два разных CTA:

| Аудитория | CTA | Copy (EN) |
|-----------|-----|-----------|
| Наблюдатель | Telegram | "Release news and digests — Castor on Telegram" → t.me/just_for_agents |
| Строитель | Discord | "Discuss, ask, show what you built — Pollux on Discord" → discord.gg/aimarket |
