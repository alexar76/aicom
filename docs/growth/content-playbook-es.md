...
| School (clips) | https://edu.modelmarket.dev/ | 13 lecciones gratis → academias |
| Courses (academias) | https://alexar76.github.io/aimarket-courses/ | 13 academias Python |
| GAIA | https://iot.modelmarket.dev/ | Relés LIVE del mundo físico |
| ATLAS | https://atlas.modelmarket.dev/ | Mapa planetario de sensores |
