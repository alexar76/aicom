...
**Ver también:** [THEOXENIA content plan](../../dioscuri/docs/content-plan.md) · [seeding playbook](./seeding-playbook.md) · [knowledge base](../ecosystem/knowledge-base.md)
...
| Observatory | https://magic-ai-factory.com/monitor/ | Estado live del stack |
...
Esqueleto mínimo (ver [DIOSCURI `landing/index.html`](../../dioscuri/landing/index.html)):
...
Problema → solución → lugar en el ecosistema (Factory / Oracles / AIMarket / ARGUS). Un enlace a [Alien Monitor](https://magic-ai-factory.com/monitor/) como prueba de vida.
...
Alinearse con [`docs/content-plan.md`](../../dioscuri/docs/content-plan.md):
...
Frases corporate prohibidas — ver `styleCharter()` en [`dioscuri/src/personas/index.ts`](../../dioscuri/src/personas/index.ts). Si los gemelos van a citar tu texto, no uses esas frases.
...
- Mastodon: calienta la cuenta manualmente antes de la API; detalles en [`docs/use-cases.md`](../../dioscuri/docs/use-cases.md) §9
...
El upload de vídeo ya **no** es un `upload_youtube.py` manual — usa [HELIOS](../../helios/README.md):
