...
> 🌐 Languages: **English** · [Русский](./content-playbook-ru.md) · [Español](./content-playbook-es.md) · [Français](./content-playbook-fr.md) · [中文](./content-playbook-zh.md)
...
**Related:** [THEOXENIA content plan](https://github.com/alexar76/dioscuri/blob/main/docs/content-plan.md) · [seeding playbook](./seeding-playbook.md) · [knowledge base](../ecosystem/knowledge-base.md)
...
| Observatory | https://monitor.modelmarket.dev/ | Live status of the stack |
| School (clip on-ramp) | https://edu.modelmarket.dev/ | 13 free lessons → academies |
| Courses (academies) | https://alexar76.github.io/aimarket-courses/ | 13 hands-on Python academies |
| GAIA (sensors) | https://iot.modelmarket.dev/ | Physical-world LIVE relays |
| ATLAS (map) | https://atlas.modelmarket.dev/ | Planetary sensor map |
...
Minimum skeleton (see [DIOSCURI `landing/index.html`](https://github.com/alexar76/dioscuri/blob/main/landing/index.html)):
...
Problem → solution → place in the ecosystem (Factory / Oracles / AIMarket / ARGUS). One link to [Alien Monitor](https://monitor.modelmarket.dev/) as proof of life.
...
Align with [`docs/content-plan.md`](https://github.com/alexar76/dioscuri/blob/main/docs/content-plan.md):
...
Banned corporate phrases — see `styleCharter()` in [`dioscuri/src/personas/index.ts`](https://github.com/alexar76/dioscuri/blob/main/src/personas/index.ts). If twins will quote your text, do not use those phrases.
...
- Mastodon: warm the account manually before API; details in [`docs/use-cases.md`](https://github.com/alexar76/dioscuri/blob/main/docs/use-cases.md) §9
...
Video upload is **not** manual `upload_youtube.py` anymore — use [HELIOS](https://github.com/alexar76/helios/blob/main/README.md):
