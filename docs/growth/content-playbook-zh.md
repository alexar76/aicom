...
| School（短课） | https://edu.modelmarket.dev/ | 13 节免费短课 → 学院 |
| Courses（学院） | https://alexar76.github.io/aimarket-courses/ | 13 门 Python 学院课 |
| GAIA | https://iot.modelmarket.dev/ | 物理世界 LIVE 中继 |
| ATLAS | https://atlas.modelmarket.dev/ | 行星传感器地图 |
| Observatory | https://monitor.modelmarket.dev/ | 整套系统的实时状态 |
...
问题 → 解决方案 → 在生态系统中的位置（Factory / Oracles / AIMarket / ARGUS）。一个指向 [Alien Monitor](https://monitor.modelmarket.dev/) 的链接作为存活证明。
