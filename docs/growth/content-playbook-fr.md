...
> 🌐 Langues : [English](./content-playbook.md) · [Русский](./content-playbook-ru.md) · [Español](./content-playbook-es.md) · **Français** · [中文](./content-playbook-zh.md)
...
**Voir aussi :** [THEOXENIA content plan](https://github.com/alexar76/dioscuri/blob/main/docs/content-plan.md) · [seeding playbook](./seeding-playbook.md) · [knowledge base](../ecosystem/knowledge-base.md)
...
| School (clips) | https://edu.modelmarket.dev/ | 13 leçons gratuites → académies |
| Courses (académies) | https://alexar76.github.io/aimarket-courses/ | 13 académies Python |
| GAIA | https://iot.modelmarket.dev/ | Relais LIVE du monde physique |
| ATLAS | https://atlas.modelmarket.dev/ | Carte planétaire des capteurs |
| Observatory | https://monitor.modelmarket.dev/ | Statut live de la stack |
...
|----------|-----|-----------|
| Observateur | Telegram | “Release news and digests — Castor on Telegram” → https://t.me/just_for_agents |
...
Squelette minimal (voir [DIOSCURI `landing/index.html`](https://github.com/alexar76/dioscuri/blob/main/landing/index.html)) :
...
Problème → solution → place dans l'écosystème (Factory / Oracles / AIMarket / ARGUS). Un lien vers [Alien Monitor](https://monitor.modelmarket.dev/) comme preuve de vie.
...
S'aligner sur [`docs/content-plan.md`](https://github.com/alexar76/dioscuri/blob/main/docs/content-plan.md) :
...
Phrases corporate interdites — voir `styleCharter()` dans [`dioscuri/src/personas/index.ts`](https://github.com/alexar76/dioscuri/blob/main/src/personas/index.ts). Si les jumeaux vont citer votre texte, n'utilisez pas ces phrases.
...
- Mastodon : chauffez le compte manuellement avant l'API ; détails dans [`docs/use-cases.md`](https://github.com/alexar76/dioscuri/blob/main/docs/use-cases.md) §9
...
L'upload vidéo n'est **plus** un `upload_youtube.py` manuel — utilisez [HELIOS](https://github.com/alexar76/helios/blob/main/README.md) :
