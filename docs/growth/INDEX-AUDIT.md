...
Last updated: 2026-09-12. Source of truth for growth tasks in the monorepo.
...
| vonzosten/awesome-LangGraph | aimarket-bridges (Packages) | 🔄 PR [#108](https://github.com/vonzosten/awesome-LangGraph/pull/108) OPEN — **alexar76** · satellite only, no monorepo tour |
| awesome-mcp-servers Security | argus | 📋 included in #9910 (was separate kit) |
| Official MCP Registry | aimarket-mcp, oracle-gateway, plugins, argus3, **warden** | ✅ **active** — `io.github.alexar76/warden` v0.5.0 · [`docs/mcp-registries/`](../mcp-registries/) · `./scripts/publish_mcp_registry.sh --check-live` |
| mcp.so / Smithery | warden: `smithery.yaml` in repo; mcp.so / Smithery UI still manual | 🔄 config ready · forms need login |
