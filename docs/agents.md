...
| `github_house_contract.md` | Shared GitHub-house OSS bar (README/hero/gallery, badges, release, coverage, bilingual docs) — injected into Architect, Developer, DevOps, QA |
