...
|--:|---|---|---|
| 1 | **AIAgentLottery** | [`0xbda3e323…84db61`](https://basescan.org/address/0xbda3e32331822d525d5e7c7b51ed76132e84db61) | native-ETH reputation-weighted lottery |
| 2 | **AIMarketEscrow** | [`0x3Df85a63…163017`](https://basescan.org/address/0x3Df85a639EAB8B50DD14f09bdeB46D5FeF163017) | USDC payment channels for capability invocation |
| 3 | **AIMarketCapabilityNFT** | [`0xA9Af496f…255033`](https://basescan.org/address/0xA9Af496fD4A1Dc594029Aa8Ea2dbd236Fd255033) | capability/credential NFTs |
| 4 | **AgentCollateralVault** | [`0xF9A387c4…21667E`](https://basescan.org/address/0xF9A387c4e81DE49dB303CE9Bd2489AF54821667E) | ACEX — agent collateral custody ♻️ |
| 5 | **AgentListingRegistry** | [`0xcF287704…f436C3`](https://basescan.org/address/0xcF28770416294358af286a2E4a2e88d6c1f436C3) | ACEX — credit-listing registry ♻️ |
| 6 | **AgentLendingPool** | [`0xB0BE9046…1c2F48`](https://basescan.org/address/0xB0BE904642EDE39135A0F1c5e5A811925b1c2F48) | ACEX — lending pool ♻️ |
| 7 | **PulseAMM** | [`0x049B839B…5d4337`](https://basescan.org/address/0x049B839BD5B30797c27f1806E06172014c5d4337) | ACEX — pulse AMM ♻️ |
| 8 | **AgentAuditPool** | [`0x86a4A9A8…060Cee`](https://basescan.org/address/0x86a4A9A85895AA10B5a8A680a7c95F4a2C060Cee) | ACEX — audit staking pool ♻️ |
| 9 | **PulseDistributor** | [`0x37F17f2B…8775e`](https://basescan.org/address/0x37F17f2B733d9D801C7f03f6A6D1E5cA8898775e) | ACEX — pulse reward distribution |
| 10 | **PlonkVerifier** | [`0xb11af6f3…0ACf65`](https://basescan.org/address/0xb11af6f387aCD57E6AECDa222D0108e6380ACf65) | ZK proof verifier (oracle proofs) |
...
> ♻️ **ACEX REDEPLOYED 2026-06-19 with all 6 audit findings fixed** (rows 4–8 — new addresses;
> the old immutable contracts are superseded). Fixes: lending first-depositor inflation
> (MINIMUM_LIQUIDITY→1e6), PulseAMM `MIN_RESERVE` drain guard, AuditPool single-division payout +
> **TWAP-only baseline** with a min observation window + never-established→default. Source +
> 49 Foundry tests in `acex/contracts/evm`; redeploy transactions in §2b below. Value-testing of
> the fixed contracts is pending (the AuditPool baseline path is time-gated by the 1-day TWAP).
