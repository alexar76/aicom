...
|--:|---|---|---|
| 1 | **AIAgentLottery** | [`0x5F3D1b3f…06daE7`](https://basescan.org/address/0x5F3D1b3f21a9db715666060c587aEB049a06daE7) | native-ETH work-seat lottery (paid tickets off) |
...
> **2026-09-11 source audit:** federation-safe work seats now bind a stable
> `participantId` (Hub URL + Hub agent id), which changes the contract ABI. The address
> recorded in this historical section does not contain that field. A new deployment and
> registry/relayer switch are required; the updated relayer returns 503 against the old
> contract rather than pretending the signature is usable.
