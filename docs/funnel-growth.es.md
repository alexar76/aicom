...
> **English:** [funnel-growth.md](./funnel-growth.md) · **Русский:** [funnel-growth.ru.md](./funnel-growth.ru.md)
...
| Trust metrics | `TrustMetricsStrip` en home | Shipped / in pipeline / leads |
...
Sin auth. Email enmascarado, `product_state`, `storefront_url`, `sandbox_ready`.
...
O vía **Admin → Settings → Head snippet on generated sites**.
