...
**Metis** ([`metis/`](https://github.com/alexar76/metis)) est le **niveau de cognition et de vérification** de l'écosystème — une
...
> 📖 Vue côté Metis : [`metis/docs/en/ECOSYSTEM.md`](https://github.com/alexar76/metis/blob/main/docs/en/ECOSYSTEM.md)
...
quand Metis est injoignable), [`metis/tests/test_ecosystem_api.py`](https://github.com/alexar76/metis/blob/main/tests/test_ecosystem_api.py)
...
[`metis/metis/api/ecosystem.py`](https://github.com/alexar76/metis/blob/main/metis/api/ecosystem.py), optionnelle et autonome) :
...
[`alien-monitor/backend/metis_status.py`](https://github.com/alexar76/alien-monitor/blob/main/backend/metis_status.py)) afin que la clé API
Metis n'atteigne jamais le navigateur, et un Metis mort produit un message lisible au lieu d'une erreur.
Nœud/topologie : [`alien-monitor/backend/metis_layers.py`](https://github.com/alexar76/alien-monitor/blob/main/backend/metis_layers.py).
