...
to force a capture) ·
[`gaia/tests/test_verifier_envelope.py`](../gaia/tests/test_verifier_envelope.py) (the hub's own
...
[`gaia/tests/test_hub_e2e.py`](../gaia/tests/test_hub_e2e.py) (hub ↔ GAIA escrow end to end).
...
the verification guarantee in [`metis/metis/api/ecosystem.py`](../metis/metis/api/ecosystem.py) ·
GAIA's envelope in [`gaia/gaia/verifier.py`](../gaia/gaia/verifier.py).
