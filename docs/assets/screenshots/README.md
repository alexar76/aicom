...
```bash
DOCS_SCREENSHOT_BASE_URL=http://5.129.212.122:9080 npm run capture-admin-dashboard
...
- Source: live demo `http://5.129.212.122:9080` (passwordless admin, EN locale, waits for KPI numbers)
