...
**См. также:** [known-issues.md](known-issues.md) · [pet-project-trust.md](pet-project-trust.md) · [oracles crypto-maturity](https://github.com/alexar76/oracles/blob/main/docs/crypto-maturity.ru.md)
...
| **A-4** | Metis | MATURITY.md | in-repo | [`metis/docs/en/MATURITY.md`](https://github.com/alexar76/metis/blob/main/docs/en/MATURITY.md) |
...
Закрыто в [crypto-maturity](https://github.com/alexar76/oracles/blob/main/docs/crypto-maturity.ru.md) + KI-6. Platon/Lumen — тот же класс «нужен внешний аудит».
