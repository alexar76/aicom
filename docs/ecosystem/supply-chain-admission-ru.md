...
| **Поднять свой Hub** и войти в федерацию | `POST /federation/announce` + sandbox assay; каталог забирает crawler | **Нет** гостевого залога. Вы **peer**. [Свой хаб](../join-the-federation.ru.md). |
