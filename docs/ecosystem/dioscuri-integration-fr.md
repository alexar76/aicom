...
Castor/Pollux annoncent les chapitres ; ils **n'usurpent pas** l'identité de Theoros. Guide complet : **[dioscuri/docs/theoros.md](https://github.com/alexar76/dioscuri/blob/main/docs/theoros.md)** (architecture, voice charter, config, checklist).
