...
**Why a theorist?** [theoros/docs/WHY.md](../../theoros/docs/WHY.md) — separatist case (legislative draft vs twin executives), theorist lineage, kill criteria.
...
| **DIOSCURI deep dive** | [dioscuri/docs/theoros.md](../../dioscuri/docs/theoros.md) — architecture, config, checklist, ops |
| **Why THEOROS (AI sovereigntist)** | [theoros/docs/WHY.md](../../theoros/docs/WHY.md) |
...
Full argument + theorist lineage table: **[theoros/docs/WHY.md](../../theoros/docs/WHY.md)**.
...
Full integration guide: **[dioscuri/docs/theoros.md](../../dioscuri/docs/theoros.md)**.
...
4. Community argues → `#canon-debate`
