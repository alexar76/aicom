...
Castor/Pollux 宣布各章节；它们**不会**假冒 Theoros。完整指南：**[dioscuri/docs/theoros.md](https://github.com/alexar76/dioscuri/blob/main/docs/theoros.md)**（架构、voice charter、配置、清单）。
