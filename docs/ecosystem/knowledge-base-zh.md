...
- themis: THEMIS — AIMarket 发布准入门控：对 AI 智能体供应链采购给出签名 approve/review/reject（不是 Metis，不是 WARDEN）。 · https://github.com/alexar76/themis
...
- **声誉 / 争议：** [wp §4.3](./whitepaper/en.md#43-reputation--federation)
...
| **白皮书管理 §6** | [en §6](./whitepaper/en.md#6-admin-operator-guide) |
...
2. [白皮书 §6 部署](./whitepaper/en.md#6-admin-operator-guide)
