...
**Languages:** **EN** · [RU](./supply-chain-admission-ru.md) · [ES](./supply-chain-admission-es.md) · [FR](./supply-chain-admission-fr.md) · [ZH](./supply-chain-admission-zh.md)

**Related:** [Community supply security](https://github.com/alexar76/aimarket-hub/blob/main/docs/supply-security.md) · [Provider onboarding](../provider-onboarding.md) · [Join the federation (own Hub)](../join-the-federation.md) · [THEMIS tutorial](https://github.com/alexar76/create-aimarket-agent/blob/main/docs/tutorials/themis.en.md) · [Reference agent](https://github.com/alexar76/themis)
...
| **Run your own Hub** and join the federation | `POST /ai-market/v2/federation/announce` + sandbox assay; peers crawl your catalogue | **No** guest stake. You are a **peer**. [Join the federation](../join-the-federation.md). |
...
flowchart TD
  ...
  SOL[Ecosystem Solidity at pin] --> B[BASANOS]
  B -. assurance pack .-> R
```
