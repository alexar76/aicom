...
| **Run your own Hub** and join the federation | `POST /federation/announce` + sandbox assay; peers crawl your catalogue | **No** guest stake. You are a **peer**. [Join the federation](../join-the-federation.md). |
