...
- themis: THEMIS — porte d’admission à la publication AIMarket : approve/review/reject signés pour la chaîne d’approvisionnement des agents IA (pas Metis, pas WARDEN). · https://github.com/alexar76/themis
...
- **Réputation / litiges :** [wp §4.3](./whitepaper/en.md#43-reputation--federation)
...
| **Livre blanc admin §6** | [en §6](./whitepaper/en.md#6-admin-operator-guide) |
...
2. [Livre blanc §6 déploiement](./whitepaper/en.md#6-admin-operator-guide)
