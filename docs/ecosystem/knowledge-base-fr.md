...
>
> **Langues :** Livre blanc **[EN](./whitepaper/en.md)** · **[RU](./whitepaper/ru.md)** · **[ES](./whitepaper/es.md)** · Guides utilisateur ARGUS **[20 langues](https://github.com/alexar76/argus/blob/main/docs/user-guide/README.md)**
...
| **Développeur d'agent / SDK** | [Spécification du protocole](../../aimarket-protocol/spec.md) · [SDK](#sdks--client-libraries) · [MCP et oracles](#mcp--seventeen-oracles) |
...
9. **SKOPOS** 🛰️ est le **satellite d'observabilité de la flotte** — analytique nginx et Apache via SSH, Security Center et un analyste IA ; en ligne sur [skopos.modelmarket.dev](https://skopos.modelmarket.dev).
10. **GAIA** 🌍 vend des **données du monde physique** vérifiables — capteurs IoT virtuels sous forme de capacités attestées par Ed25519 et vérifiées statistiquement pour leur plausibilité. C'est la **troisième classe d'oracles** : mathématique (oracles ×17), cognitive (Metis), physique (GAIA).
...
|----------|----------------|
| Livre blanc de l'écosystème | `docs/ecosystem/whitepaper/{en,ru,es}.md` |
