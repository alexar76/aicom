...
**Проводка mesh** на этой машине не автоматическая — нужны скрипты ниже, чтобы
известные хабы видели друг друга. После стука продуктовый допуск другой: песочница
сама принимает `pass` (см. [`join-the-federation.ru.md`](../join-the-federation.ru.md)).
Скрипты по-прежнему делают явный `approve`, чтобы лабораторный пир был trusted даже
без бесплатного sandbox-SKU.
