...
9. **aimarket-bridges** 🌉 — **нативные инструменты LangGraph / CrewAI / AutoGen** из возможностей Hub — подписанные квитанции, бюджеты, установка в две строки.
10. **SKOPOS** 🛰️ — **спутник наблюдаемости флота** — аналитика nginx и Apache по SSH, Security Center и AI-аналитик; работает на [skopos.modelmarket.dev](https://skopos.modelmarket.dev).
11. **GAIA** 🌍 продаёт верифицируемые **данные о физическом мире** — виртуальные IoT-датчики как возможности, аттестованные Ed25519 и статистически проверенные на правдоподобие. Это **третий класс оракулов**: математический (оракулы ×17), когнитивный (Metis), физический (GAIA).
