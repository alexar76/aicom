...
| **Levantar tu Hub** y unirte a la federación | `POST /federation/announce` + sandbox assay; el catálogo se rastrea | **No** hay stake de invitado. Eres **peer**. [Unirse a la federación](../join-the-federation.es.md). |
