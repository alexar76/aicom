...
**语言：** [EN](./supply-chain-admission.md) · [RU](./supply-chain-admission-ru.md) · [ES](./supply-chain-admission-es.md) · [FR](./supply-chain-admission-fr.md) · **ZH**

**相关：** [Community supply security](https://github.com/alexar76/aimarket-hub/blob/main/docs/supply-security.md) · [提供方入门](../provider-onboarding.md) · [自建枢纽（联邦）](../join-the-federation.zh.md) · [THEMIS 教程](https://github.com/alexar76/create-aimarket-agent/blob/main/docs/tutorials/themis.zh.md) · [参考智能体](https://github.com/alexar76/themis)
...
| **自建 Hub** 并加入联邦 | `POST /ai-market/v2/federation/announce` + 沙箱 assay；目录被 crawl | **无**访客保证金。你是 **peer**。[加入联邦](../join-the-federation.zh.md)。 |
...
- **自建 Hub** 作为联邦 peer：[加入联邦](../join-the-federation.zh.md)。通告免费；准入看枢纽 *实际做了什么*。这不是在别人目录里免费挂一条。
