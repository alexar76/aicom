...
10. **SKOPOS** 🛰️ is the **fleet observability satellite** — nginx & Apache analytics over SSH, Security Center, and an AI analyst; live on [skopos.modelmarket.dev](https://skopos.modelmarket.dev).
11. **GAIA** 🌍 sells verifiable **physical-world data** — virtual IoT sensors as Ed25519-attested, statistically plausibility-verified capabilities. It is the **third oracle class**: mathematical (oracles ×17), cognitive (Metis), physical (GAIA).
