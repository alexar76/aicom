...
Castor/Pollux anuncian los capítulos; **no** suplantan a Theoros. Guía completa: **[dioscuri/docs/theoros.md](https://github.com/alexar76/dioscuri/blob/main/docs/theoros.md)** (arquitectura, voice charter, config, checklist).
