...
| **Despliegue (UNI vs LIVE)** | [uni-and-live.es.md](../uni-and-live.es.md) — dos hubs, dos mapas, dos catálogos |
...
**Admisión de componentes de terceros:** staking + firmas — [`supply-security.md`](https://github.com/alexar76/aimarket-hub/blob/main/docs/supply-security.md); puerta de publicación THEMIS — [supply-chain-admission-es.md](./supply-chain-admission-es.md) ([EN](./supply-chain-admission.md) · [RU](./supply-chain-admission-ru.md) · [FR](./supply-chain-admission-fr.md) · [ZH](./supply-chain-admission-zh.md)). **Dos puertas de vendedor:** garantía de invitado ≈ $25 en un Hub ajeno, o [tu propio Hub](../join-the-federation.es.md) como peer (sin stake de invitado). Auditor = ¿admitir?; WARDEN = ¿este invoke ahora?; Metis = dictamen; MOMUS = review; Monitor = historial; Hub = aplicar.
...
Dos procesos, dos hubs, dos catálogos. Tabla completa: **[uni-and-live.es.md](../uni-and-live.es.md)** (EN · [RU](../uni-and-live.ru.md) · [ES](../uni-and-live.es.md) · [FR](../uni-and-live.fr.md) · [ZH](../uni-and-live.zh.md)).
...
| Catálogo | federación en vivo (Platon, ATLAS, GAIA, oráculos, …) | seis laboratorios de burbuja: KHRONOS, STOICHEION, HORIZON, PSEPHOS, KYMA, DIKTYON |
| Dinero | Base cuando el cripto está ON | Anvil `31337` — simulado |

Esos seis laboratorios **no** son pares de la federación LIVE. Platon en el mapa UNI es una superposición de estado de un servicio en vivo, no un par del catálogo UNI. TEST es una tercera capa sobre el mismo proceso del monitor, no una tercera economía.
...
| AIMarket Hub **LIVE** | [modelmarket.dev](https://modelmarket.dev) | Marketplace federado |
| AIMarket Hub **UNI** | [uni.modelmarket.dev](https://uni.modelmarket.dev) | Catálogo paralelo sellado — [uni-and-live.es.md](../uni-and-live.es.md) |
...
| Alien Monitor **UNI** | [monitor-uni.modelmarket.dev/](https://monitor-uni.modelmarket.dev/) | Grafo 3D de la burbuja · `ALIEN_MODE=universe` |
| Alien Monitor **LIVE** | [monitor.modelmarket.dev/](https://monitor.modelmarket.dev/) | Grafo 3D del dinero en vivo · `ALIEN_MODE=real` |
...
Fuente: [alexar76/dioscuri](https://github.com/alexar76/dioscuri) · **Landing:** [alexar76.github.io/dioscuri](https://alexar76.github.io/dioscuri/) · **Playbook de contenido:** [docs/growth/content-playbook.md](../growth/content-playbook.md) · Nodo del monitor: haz clic en **DIOSCURI** en [Alien Monitor](https://monitor.modelmarket.dev/).
...
|---|---|---|---|
| gaia.weather.read@v1 | weather (Clima) | om-wx-01, nws-01, cwop-01, metno-01 +267 | device_id anclado por el operador; LIVE solo con provenance source |
...
| gaia.river.read@v1 | river (Ríos) | usgs-river-01, eccc-hydro-01, smhi-hydro-01, pegel-bonn-01 +163 | device_id anclado por el operador; LIVE solo con provenance source |
...
| gaia.spacewx.read@v1 | spacewx (Clima espacial) | swpc-01, swpc-solarwind-01, swpc-xray-01, donki-01 | NOAA SWPC Kp; pin Boulder, índice planetario |
...
| gaia.precipitation.read@v1 | precipitation (Precipitación) | imerg-01 + lat/lon del comprador | cualquier coordenada del comprador; celda IMERG devuelta; preliminar |
| gaia.radar.status.read@v1 | radar (Estado NEXRAD) | nexrad-status-01 (todos los sitios WSR-88D) | todos los sitios WSR-88D en sus coordenadas; estado, no reflectividad |
| gaia.sea_ice.read@v1 | sea_ice (Hielo marino) | nsidc-ice-01 + lat/lon árticos del comprador | cualquier coordenada ártica; celda exacta de 25 km; no para navegación |
| gaia.aviation.read@v1 | aviation (METAR aviación) | metar-kjfk-01, metar-klga-01, metar-kbos-01, metar-kord-01 +10 | METAR NOAA AWC (U.S. PD); pin ASOS in situ, no un TAF |
| gaia.road.read@v1 | road (Clima vial) | fintraffic-road-01 | clima vial Fintraffic Digitraffic CC BY 4.0; solo carreteras finlandesas |
| gaia.rail.read@v1 | rail (Tráfico ferroviario) | fintraffic-rail-01 | ubicaciones ferroviarias Fintraffic Digitraffic CC BY 4.0; solo FI |
| gaia.drought.read@v1 | drought (Sequía) | usdm-01 | U.S. Drought Monitor, stats semanales por estado; atribuir NDMC/USDA/NOAA/NASA |
| gaia.uv.read@v1 | uv (UV forecast) | epa-uv-01 | device_id anclado por el operador; LIVE solo con provenance source |
| gaia.energy.read@v1 | energy (Energía) | em-01 | device_id anclado por el operador; LIVE solo con provenance source |
| gaia.reservoir.read@v1 | reservoir (Reservoirs) | usace-keys-01, usace-pine-01, usace-deni-01, usace-huds-01 | device_id anclado por el operador; LIVE solo con provenance source |
| gaia.atmosphere.read@v1 | atmosphere (Atmósfera) | cams-* + lat/lon del comprador | cualquier coordenada del comprador; CAMS CC BY 4.0; requiere hosting comercial |
| gaia.dart.read@v1 | dart (Boyas DART) | noaa-dart-01, dart-* (los 43 activos) | todas las estaciones activas del directorio NDBC; medidor, no alerta de tsunami |
| gaia.radnet.read@v1 | radnet (EPA RadNet) | radnet-* (los 140 monitores oficiales) | las 140 coordenadas oficiales de monitores EPA; atribuir EPA RadNet |
| gaia.soil_moisture.read@v1 | soil (Humedad del suelo) | soil-* + lat/lon del comprador | cualquier coordenada del comprador; celda fuente/consulta CLMS devuelta |
| gaia.solar.read@v1 | solar (Irradiación solar) | solar-* + lat/lon del comprador | cualquier coordenada del comprador; coordenada fuente NASA POWER devuelta |
| gaia.snow.read@v1 | snow (Manto de nieve) | snow-* + lat/lon del comprador en CONUS | cualquier coordenada del comprador en CONUS; celda SNODAS exacta |
| gaia.land_temperature.read@v1 | land_temperature (Temperatura terrestre) | lst-* + lat/lon del comprador | cualquier coordenada del comprador; celda Sentinel-3 SLSTR devuelta |
...
| atlas.smoke.operations@v1 | 0.12 | point-in-polygon contra el contorno HMS firmado + PM2.5/AQI colocalizado; rechaza si el inventario está truncado; no es PM2.5 medido ni una orden de evacuación |
...
| atlas.geomag.window@v1 | 0.05 | Kp planetario de SWPC → estado/escala G de NOAA + F del observatorio USGS más cercano; solo campo total, NO una corrección de declinación ni safety-of-life |
| atlas.pv.irradiance.record@v1 | 0.15 | irradiación diaria NASA POWER (all-sky vs clear-sky) + aerosol/polvo CAMS en la coordenada de la planta; registro retrospectivo de hechos, NO un pronóstico de producción ni un modelo de pérdidas por suciedad |
...
|-----------|---------------|----------------|----------|
| **AI-Factory** | `web/`, `agents/`, `config/` | [alexar76/aicom](https://github.com/alexar76/aicom) | [USER_GUIDE](../USER_GUIDE.md) · [wp §3.1](./whitepaper/es.md#31-ai-factory) |
| **AIMarket Hub** | `aimarket-hub/` | [aimarket-hub](https://github.com/alexar76/aimarket-hub) | [wp §3.2](./whitepaper/es.md#32-aimarket-hub) |
...
| **Service Mesh** | `ai-service-mesh/` | [ai-service-mesh](https://github.com/alexar76/ai-service-mesh) | [wp §3.5](./whitepaper/es.md#35-ai-service-mesh) |
...
| **ARGUS-3** | `argus/` | [argus](https://github.com/alexar76/argus) | [wp §3.7](./whitepaper/es.md#37-argus-3) · [wiki](https://github.com/alexar76/argus/wiki) |
| **Alien Monitor** | `alien-monitor/` | [alien-monitor](https://github.com/alexar76/alien-monitor) | [wp §3.8](./whitepaper/es.md#38-alien-monitor) · [UNI / LIVE](../uni-and-live.es.md) |
| **ACEX** | `acex/` | [acex](https://github.com/alexar76/acex) | [wp §3.10](./whitepaper/es.md#310-acex--agent-capital-exchange) |
| **Lottery** | `lottery/` | [lottery](https://github.com/alexar76/lottery) | [wp §3.11](./whitepaper/es.md#311-agent-lottery) |
...
- cite-desks: Cite desks — escritorios de evidencia independientes sobre rieles AIMarket. Un repo padre: kernel + Emberline / Tideline / Solrecord / Seamark / Plinth, cada uno con su README. · https://desk.modelmarket.dev/
...
- dolos: DOLOS — red team dinámico de EVM para la burbuja UNI: forkea el Anvil de la burbuja y lanza transacciones de exploit reales contra los contratos desplegados para probar qué fallos son reales frente al ruido del análisis estático; hallazgos firmados con Ed25519; solo en la cadena sandbox ejecuta el ciclo completo ataque->corrección->forge-test->redespliegue->reataque. Nunca toca una cadena que no pueda desechar; un hallazgo de mainnet es consultivo. · https://dolos.modelmarket.dev/
- escrow-signer: HORKOS guarda la única clave autorizada en AIMarketEscrow.authorizedHubs para que no la guarde el Hub — un selector permitido, un depósito en garantía, una red, y la firma EIP-712 del comprador como autoridad sobre cada importe. · https://alexar76.github.io/escrow-signer/
...
- hestia: HESTIA — el runtime alojado: aislado, para proveedores de capacidad AIMarket en las máquinas del operador. No es el catálogo del Hub, ni un tablón de empleos, ni Factory. Los agentes aparecen solo tras un despliegue firmado en este host. · https://hestia.modelmarket.dev · port 9480
- histor: HISTOR — registro de transparencia público de las definiciones de herramientas MCP: lee lo que anuncian los endpoints remotos del registro oficial de MCP (sin llamar a herramientas), lo firma como etiquetas MTL/1, lo añade a un árbol de Merkle RFC 9162 y responde en /check si lo que recibió un cliente coincide con lo observado. Nunca declara seguro a un servidor. · https://alexar76.github.io/histor/
...
- themis: THEMIS — puerta de admisión al publicar en AIMarket: approve/review/reject firmados para la cadena de suministro de agentes de IA (no Metis, no WARDEN). · https://alexar76.github.io/themis/
...
- **Reputación / disputas:** [wp §4.3](./whitepaper/es.md#43-reputación-y-federación)
...
|-------------|------|-----|
| **Factory protocol gateway** | 402 + MCP + invoke sobre productos entregados | [wp §3.1](./whitepaper/es.md#31-ai-factory) |
...
| **Libro blanco admin §6** | [ES §6](./whitepaper/es.md#6-guía-del-operador-admin) |
...
2. [Resumen ejecutivo del libro blanco + §1 ideología](./whitepaper/es.md#0-resumen-ejecutivo)
...
2. [Libro blanco §6 despliegue](./whitepaper/es.md#6-guía-del-operador-admin)
