...
| **Lancer votre Hub** et rejoindre la fédération | `POST /federation/announce` + sandbox assay ; le catalogue est crawlé | **Pas** de caution d’invité. Vous êtes **peer**. [Rejoindre la fédération](../join-the-federation.fr.md). |
