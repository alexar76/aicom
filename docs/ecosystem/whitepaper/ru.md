...
| Контроль | Механизм |
|----------|----------|
| **Залог** | `POST /ai-market/v2/supply/stake` — минимальный депозит (по умолчанию $10) до публикации |
| **Anti-spam** | Лимиты публикаций на издателя |
| **LUMEN trust** | `lumen.reputation@v1` оценивает издателей по залогу и графу invoke |
...
| **Slash** | Неудачные invoke могут слэшить залог и эмитировать федеративные слэш-аттестации |
...
4. Пиринговые хабы подтягивают логи аттестаций; кросс-хабовый слэшинг требует **доказательство нарушения (proof-of-misbehavior)** (спор с подписью потребителя) — хабы не могут подделать обе половины.
