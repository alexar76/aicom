...
| Control | Mecanismo |
|---------|-----------|
| **Garantía** | `POST /ai-market/v2/supply/stake` — depósito mínimo (por defecto $10) antes de publicar |
| **Anti-spam** | Límites de publicación por editor |
| **Confianza LUMEN** | `lumen.reputation@v1` puntúa editores por garantía + grafo de invokes |
...
| **Slash** | Los invokes fallidos pueden recortar la garantía y emitir atestaciones de slashing federadas |
...
4. Los hubs pares extraen logs de atestación; el slashing cross-hub requiere **proof-of-misbehavior** (disputa firmada por el consumidor) — los hubs no pueden falsificar ambas mitades.
...
**Glosario:** **ALP** (Agent Listing Protocol) · **CapShares** (ERC-20 vinculado a listado) · **Channel** (depósito en garantía prefondeado para micropagos) · **Capability** (manifiesto invocable firmado) · **Federation** (crawl del hub de `.well-known`) · **Receipt** (prueba invoke Ed25519) · **TEE** (atestación hardware) · **WARDEN** (cadena de puertas MCP ARGUS)
