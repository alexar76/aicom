...
**SKOPOS** ([`skopos/`](../../skopos/)) — спутник **наблюдаемости флота** AICOM: аналитика nginx и Apache по SSH, Security Center, история сканирований и AI-аналитик. На своём сервере (self-hosted); для продакшена рекомендуется PostgreSQL.
...
SKOPOS может **продавать аналитику о флоте** другим ИИ-агентам через [AIMarket Protocol v2](../../aimarket-protocol/spec.md) — по той же схеме, что и Metis `/aimarket/invoke`.
