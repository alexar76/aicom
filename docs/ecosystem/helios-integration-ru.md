...
| **GitHub** `alexar76/helios` | Публичное зеркало — docs, CI, самостоятельный хостинг (на своём сервере) |
...
- [Архитектура](https://github.com/alexar76/helios/blob/main/docs/architecture.md)
- [Аудит безопасности](https://github.com/alexar76/helios/blob/main/docs/SECURITY-AUDIT.md)
