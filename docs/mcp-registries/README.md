...
|---------------|--------------------------|-------------|
| `io.github.alexar76/aimarket-mcp` | [`aimarket-mcp/server.json`](https://github.com/alexar76/aimarket-mcp/blob/main/server.json) | [alexar76/aimarket-mcp](https://github.com/alexar76/aimarket-mcp) |
| `io.github.alexar76/aimarket-oracle-gateway` | [`plugins/aimarket-oracle-gateway/server.json`](https://github.com/alexar76/aimarket-oracle-gateway/blob/main/server.json) | [alexar76/aimarket-oracle-gateway](https://github.com/alexar76/aimarket-oracle-gateway) |
| `io.github.alexar76/aimarket-plugins` | [`plugins/aimarket-mcp-packager/server.json`](https://github.com/alexar76/aimarket-plugins/blob/main/plugins/aimarket-mcp-packager/server.json) | [alexar76/aimarket-plugins](https://github.com/alexar76/aimarket-plugins) |
| `io.github.alexar76/argus3` | [`argus/server.json`](https://github.com/alexar76/argus/blob/main/server.json) | [alexar76/argus](https://github.com/alexar76/argus) |
| `io.github.alexar76/warden` | [`warden/server.json`](https://github.com/alexar76/warden/blob/main/server.json) | [alexar76/warden](https://github.com/alexar76/warden) |
...
1. Glama — Sync Server (build steps for aimarket-mcp: see [`aimarket-mcp/docs/GLAMA.md`](https://github.com/alexar76/aimarket-mcp/blob/main/docs/GLAMA.md))
