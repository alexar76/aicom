...
**GAIA** ([`gaia/`](../gaia/)) is the ecosystem's **physical-world oracle gateway** — virtual
...
> 📖 Satellite view: [`gaia/README.md`](../gaia/README.md)
> 📖 Protocol profile: [`aimarket-protocol/spec.md` § 4.3 IoT / Physical-Oracle Profile](../aimarket-protocol/spec.md)
...
|---|---|---|---|---|
| **Mathematical** | [`oracles/`](../oracles/) ×17, oracle-family | provable computation | proof re-verified deterministically, byte-for-byte | true / false |
| **Cognitive** | [Metis](../metis/) | LLM judgement vs buyer intent | Understanding Council → MoA → verifier | `verify_score` ∈ [0, 1] |
...
Code: [`gaia/gaia/capabilities.py`](../gaia/gaia/capabilities.py) (runtime + capability spec) ·
[`gaia/gaia/app.py`](../gaia/gaia/app.py) (HTTP surface) ·
devices in [`gaia/gaia/devices/`](../gaia/gaia/devices/).
...
Guaranteed by tests: [`gaia/tests/test_hub_e2e.py`](../gaia/tests/test_hub_e2e.py) — a full
...
[`gaia/tests/test_app_and_wot.py`](../gaia/tests/test_app_and_wot.py).

Code: [`gaia/gaia/verifier.py`](../gaia/gaia/verifier.py) (envelope + audit-string parsing) ·
hub side in
[`aimarket-hub/aimarket_hub/verified_settlement.py`](../aimarket-hub/aimarket_hub/verified_settlement.py).
...
Guaranteed by tests:
[`gaia/tests/test_attestation_and_plausibility.py`](../gaia/tests/test_attestation_and_plausibility.py) —
...
Code: [`gaia/gaia/plausibility.py`](../gaia/gaia/plausibility.py) (physics table + checks +
scoring) · [`gaia/gaia/fleet.py`](../gaia/gaia/fleet.py) (history ring buffers, sibling
registry).
...
([spec § 4.3](../aimarket-protocol/spec.md)).
...
[`gaia/tests/test_app_and_wot.py`](../gaia/tests/test_app_and_wot.py) and enforced end-to-end
(hub side) in [`gaia/tests/test_hub_e2e.py`](../gaia/tests/test_hub_e2e.py).

Code: [`gaia/gaia/attestation.py`](../gaia/gaia/attestation.py) ·
[`gaia/gaia/middleware.py`](../gaia/gaia/middleware.py) (pure-ASGI response signer).
...
preserved) in [`gaia/tests/test_app_and_wot.py`](../gaia/tests/test_app_and_wot.py).

Code: [`gaia/gaia/wot.py`](../gaia/gaia/wot.py) · endpoints in
[`gaia/gaia/app.py`](../gaia/gaia/app.py).
...
- **Not specified: per-event streaming.** Server-push with per-message micro-debit is
  ...
  [IoT / Physical-Oracle Profile in `aimarket-protocol/spec.md` § 4.3](../aimarket-protocol/spec.md)
...
[`gaia/tests/test_hub_e2e.py`](../gaia/tests/test_hub_e2e.py); window bundle ordering and
count in [`gaia/tests/test_app_and_wot.py`](../gaia/tests/test_app_and_wot.py).
...
Guaranteed by tests:
[`gaia/tests/test_security.py`](../gaia/tests/test_security.py) and the hub regressions in
...
- **Seller-hosted verification is a conflict of interest.** GAIA judging GAIA demonstrates
  ...
  [protocol profile](../aimarket-protocol/spec.md) requires (SHOULD NOT be the seller).
