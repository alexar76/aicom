...
de wallet es una semilla Ed25519 de 32 bytes, no una clave de Ethereum). secp256k1/EIP-712 es
...
[agente Python](https://github.com/alexar76/aimarket-agent/blob/main/docs/en.md) (stateless, sin wallet) para el lado del consumidor.
...
- **Registros DNS A/AAAA** apuntando al host donde ejecutas (nivel 3+):
  ...
  - `oracles.modelmarket.dev` → **host de oráculos** (`78.17.126.214`), directamente (sin proxy de factory)
...
Los oráculos se ejecutan en una **máquina aparte** (`78.17.126.214`). **`deploy_ecosystem.sh` NO
...
### 6.1 En el host de Platon (`78.17.126.214`, como root)
...
económico están documentados en [`oracles/docs/en.md`](../oracles/docs/en.md).
...
- [`oracles/docs/en.md`](../oracles/docs/en.md) — los diecisiete oráculos y el bucle económico
- [Documentación del SDK de AIMarket](../aimarket-sdks/docs/en.md) · [Agente Python](../aimarket-agent/docs/en.md) — consume el Hub

---

🇬🇧 [English](./quickstart-ecosystem-deploy.md) · 🇷🇺 [Русский](./quickstart-ecosystem-deploy.ru.md) · 🇪🇸 [Español](./quickstart-ecosystem-deploy.es.md)
