...
**Environment**
- **Server 1** `oracles.modelmarket.dev` — oracles (family :9400, chronos :9300, platon :9200),
  aimarket-hub (:9083), alien-monitor, lottery anvil chain, Gitea. 11 GiB RAM.
- **Server 2** `modeldev.modelmarket.dev:8443` — aicom factory app (:90xx), mesh-api, modelmarket-hub,
  alien-monitor, UNI lottery relayer, Grafana/Prometheus, landing. 7.8 GiB RAM.
- **Chain** Base mainnet (8453); deployer/owner wallet — see ops vault.
