...
>
> Это дверь **своего Hub** (гостевых $25 нет). Другая дверь — гостевой листинг на чужом Hub: залог ≈ **$25** в production — [допуск по цепочке поставок](ecosystem/supply-chain-admission-ru.md).
