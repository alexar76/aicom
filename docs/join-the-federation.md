...
>
> This is the **own-Hub** seller door (no guest $25). Listing as a *guest publisher* on someone else's Hub is the other door: ≈ **$25** production collateral — [supply-chain admission](ecosystem/supply-chain-admission.md).
