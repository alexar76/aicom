...
> **Para quién:** operadores de la fábrica, dueños del instancia, soporte — vitrina, admin, pipeline.  
> **English (mismas capturas):** [USER_GUIDE.md](./USER_GUIDE.md) · **FAQ:** [FAQ.es.md](./FAQ.es.md) · **Русский:** [USER_GUIDE.ru.md](./USER_GUIDE.ru.md)
...
| «Sesión expulsada» | De nuevo **/admin/login** | 401 → JWT caducado | ![Login](./assets/screenshots/admin-login.png) |
...
La ruta **`/docs`** en Next.js es un hub para stakeholders sin git: inicio rápido, capturas de admin, enlaces.
...
| [owner-guide.md](./owner-guide.md) | Dueño del instancia en producción |
