...
* **A satellite in the map that was never pushed.** `attested` (under `attested/`
  in the monorepo) was added with `github_published: false` so knowledge bases
  must not invent GitHub homepages for it until the first intentional mirror.
