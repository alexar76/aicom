#!/usr/bin/env bash
# Deploy DIOSCURI on the oracle host (78.17.126.214) from monorepo root.
#
...
#   2. ssh root@78.17.126.214       — git pull + docker compose on oracle
#
...
#
# Env:
#   ORACLE_HOST          default root@78.17.126.214  (or `ssh oracle` after ~/.ssh/config)
...
GITEA_REPO="${GITEA_DIOSCURI_REPO:-http://78.17.126.214:3000/alexar76/dioscuri.git}"
HEALTH_URL="${ORACLE_DIOSCURI_HEALTH:-http://78.17.126.214:${DIOSCURI_HTTP_PORT:-8790}/health}"
