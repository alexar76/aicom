...
def tls_names_from_env(hub: str) -> list[str]:
    ...
    return sorted({
        ...
        "atlas.modelmarket.dev", "verify.modelmarket.dev",
        "attestedmemory.net", "hub.attestedmemory.net", "monitor.attestedmemory.net",
        "memory.attestedmemory.net", "truth.attestedmemory.net",
        "provenance.attestedmemory.net",
...
def collect(mode: str, *, hub: str, signer: str, status_url: str, settlement_url: str,
    ...
    checks += probe_tls_expiry(tls_names_from_env(hub), min(timeout, 8.0))
