...
")"
  ...
  case "$sat_id" in
    ...
    attested-memory-hub)
      local extra_excludes
      extra_excludes="$(_python_map exclude-paths attested-memory-hub)"
      export_simple "$sat_id" "attested-memory-hub" "attested-memory-hub" "apache-2.0" "$extra_excludes"
      ;;
    attested-saas-gateway)
      local extra_excludes
      extra_excludes="$(_python_map exclude-paths attested-saas-gateway)"
      export_simple "$sat_id" "attested-saas-gateway" "attested-saas-gateway" "mit" "$extra_excludes"
      ;;
    escrow-signer)
      local extra_excludes
...
echo "  https://${GITHUB_HOST}/${GITHUB_ORG}/attested-memory-hub"
echo "  https://${GITHUB_HOST}/${GITHUB_ORG}/attested-saas-gateway"
