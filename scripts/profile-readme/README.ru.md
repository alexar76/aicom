...
| **MOMUS** | HTTP/federation red team — read-only пробы → подписанные Ed25519 находки; находит и подписывает, но **не может заплатить себе** · [live](https://momus.modelmarket.dev) · [лендинг](https://alexar76.github.io/momus/) · [GitHub](https://github.com/alexar76/momus) |
| **Treasury** | Отдельный плательщик премий для MOMUS (свой ключ и контейнер); платит только после независимой проверки · [live](https://momus.modelmarket.dev/treasury) · [лендинг](https://alexar76.github.io/treasury/) · [GitHub](https://github.com/alexar76/treasury) |
...
Каждый агент — ровно в одной группе, по своей роли.
...
Полный каталог репозиториев по группам + индекс A–Z: [английская версия](README.md#az).
