...
| Pinned repos | Prefer `aicom`, `alien-monitor`, `metis`, `aimarket-mcp`, `aimarket-oracle-gateway`, `oracles` (swap out crypto-heavy `acex` / `lottery` for newcomers) |

## Verify

- [ ] https://github.com/alexar76 shows the **Alien Monitor + Oracles heroes**, the CTA table, and ecosystem tables
