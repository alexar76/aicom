...
- [ ] Profile first screen is Playground · Alien Monitor · School; `./start.sh --everything` is below the live CTAs
- [ ] `aimarket-courses` (10 academies) listed under 3D visualization, learning & sample apps
...
- [ ] https://modeldev.modelmarket.dev project cards use `github.com/alexar76/<repo>` (not `aicom/tree/main/...`)
...
| https://monitor.modelmarket.dev/ | Alien Monitor UI |
| https://magic-ai-factory.com/pulse/ | Pulse Terminal |
| https://modelmarket.dev | Hub / well-known |
| https://modeldev.modelmarket.dev | Ecosystem landing |
