...
# (e.g. Benjamin Ayivoh and anyone in scripts/aicom-coauthors.txt stay).
_BLOCKED = re.compile(
    r"(github-actions|github-actions\[bot\]|cursor[-\s]?agent|cursor|claude|anthropic|openai|composer|"
    r"copilot|dependabot|noreply@anthropic\.com|devin-ai|swe-agent|openhands|"
