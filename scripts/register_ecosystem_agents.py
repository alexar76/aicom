...
_DEFAULT_SEED = "aicom-ecosystem"
SEED = os.environ.get("WALLET_SEED", "").strip()
if not SEED or SEED == _DEFAULT_SEED:
    raise SystemExit(
        "WALLET_SEED must be set to a non-default secret "
        "(do not use the public placeholder 'aicom-ecosystem')."
    )
