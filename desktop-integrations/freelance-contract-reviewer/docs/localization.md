...
1. Create JSON in one of these folders:
   - `~/Documents/AICOM/language-packs/freelance-contract-reviewer/xx.json` (desktop)
   - `language-packs/freelance-contract-reviewer/xx.json` (next to the app / repo root for dev)
...
Example: see `language-packs/freelance-contract-reviewer/de.json` in this repo.
