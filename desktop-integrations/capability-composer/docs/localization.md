...
1. Create JSON in one of these folders:
   - `~/Documents/AICOM/language-packs/capability-composer/xx.json` (desktop)
   - `language-packs/capability-composer/xx.json` (next to the app / repo root for dev)
...
Example: see `language-packs/capability-composer/de.json` in this repo.
