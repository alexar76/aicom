...
1. Create JSON in one of these folders:
   - `~/Documents/AICOM/language-packs/discovery-prospector/xx.json` (desktop)
   - `language-packs/discovery-prospector/xx.json` (next to the app / repo root for dev)
...
Example: see `language-packs/discovery-prospector/de.json` in this repo.
