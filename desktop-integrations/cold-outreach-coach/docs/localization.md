...
1. Create JSON in one of these folders:
   - `~/Documents/AICOM/language-packs/cold-outreach-coach/xx.json` (desktop)
   - `language-packs/cold-outreach-coach/xx.json` (next to the app / repo root for dev)
...
Example: see `language-packs/cold-outreach-coach/de.json` in this repo.
