...
1. Create JSON in one of these folders:
   - `~/Documents/AICOM/language-packs/personal-finance-coach/xx.json` (desktop)
   - `language-packs/personal-finance-coach/xx.json` (next to the app / repo root for dev)
...
Example: see `language-packs/personal-finance-coach/de.json` in this repo.
