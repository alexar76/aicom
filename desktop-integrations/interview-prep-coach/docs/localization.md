...
1. Create JSON in one of these folders:
   - `~/Documents/AICOM/language-packs/interview-prep-coach/xx.json` (desktop)
   - `language-packs/interview-prep-coach/xx.json` (next to the app / repo root for dev)
...
Example: see `language-packs/interview-prep-coach/de.json` in this repo.
