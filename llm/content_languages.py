...
- **Docs exception (GitHub house):** `README.md` + `docs/en.md` are always English.
  When `content_language` is not `en`, also ship `README.<code>.md` and `docs/<code>.md`
  in that language and cross-link them. UI copy stays monolingual; documentation does not.
