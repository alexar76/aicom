...
> **Documentation:** [Ecosystem knowledge base](../docs/ecosystem/knowledge-base.md) · [RU](../docs/ecosystem/knowledge-base-ru.md) · [Whitepaper](../docs/ecosystem/whitepaper/en.md)

[![Alien Monitor — full ecosystem graph with live metrics, Capability NFT panel, and activity stream](https://github.com/alexar76/alien-monitor/blob/main/docs/screenshots/09-ecosystem-simulation.png)](https://magic-ai-factory.com/monitor/)

*Alien Monitor — 3D graph of Hub, Mesh, ARGUS, SDKs, plugins, and on-chain activity. [Open live →](https://magic-ai-factory.com/monitor/)*

A single-file, dependency-free landing page that explains the whole AICOM
ecosystem (AI-Factory, AIMarket Hub, **Oracles**, **Metis**, **aimarket-mcp** MCP gateway,
