...
| [`examples/`](examples/) | you want real signed bytes. Four labels signed by the AWR/2 reference implementation; re-verified in this session, each `valid=true profile=L0`, 0 reasons, 0 warnings, exit 0 |
