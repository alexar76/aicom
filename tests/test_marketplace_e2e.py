...
def api_url():
    ...
    return os.environ.get("AI_FACTORY_API_URL", "http://localhost:9081")
...
class TestMarketplaceAPI:
    ...
    def test_categories_endpoint(self, api_url):
    ...
    def test_products_list_category_filter(self, api_url):
    ...
    def test_product_detail_has_marketplace_fields(self, api_url):
        ...
        try:
            ...
            assert "evolution_history" in detail
