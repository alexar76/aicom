...
def test_sharper_reopen_clears_hold_and_lock():
    """Otherwise BUG_FOUND stays stranded under pipeline_on_hold from auto-recovery COMPLETE."""
    assert "set_product_pipeline_on_hold(pid, False)" in BODY
    assert 'product["operator_locked"] = False' in BODY
