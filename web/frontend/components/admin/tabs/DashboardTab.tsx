...
import { FunnelDashboardCard } from '@/components/admin/FunnelDashboardCard';
import { MetisDashboardCard } from '@/components/admin/MetisDashboardCard';
...
export function DashboardTab({ locale }: { locale: AdminLocale }) {
  ...
  const stats = [
    ...
    },
    {
      ...
      title: t(locale, 'dashboard.stat.storefrontHint'),
    },
    {
  ...
  return (
    <motion.div className="space-y-8">
      ...
      <MetisDashboardCard locale={locale} />
