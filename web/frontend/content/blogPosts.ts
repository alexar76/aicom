/**
 * Editorial blog posts (human-written playbooks). Launch posts are generated by the
 * Marketing agent when a product pipeline completes — see GET /api/blog/posts.
 */
...
/** Human-authored editorial posts (playbooks). Launch posts come from /api/blog. */
export const EDITORIAL_BLOG_POSTS: BlogPost[] = BLOG_POSTS;
