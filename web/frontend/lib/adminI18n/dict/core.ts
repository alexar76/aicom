...
export const CORE_DICT: I18nDict = {
  ...
  'tab.factoryFloor': { en: 'Factory Floor', ru: 'Цех агентов', es: 'Planta de agentes' },
  'tab.timeTravel': { en: 'Time Travel', ru: 'Путешествие во времени', es: 'Viaje en el tiempo' },
  'tab.showcase': { en: 'Showcase', ru: 'Витрина демо', es: 'Escaparate' },
  'tab.promptLoop': { en: 'Prompt Loop', ru: 'Петля промптов', es: 'Bucle de prompts' },
  ...
  'actionLog.refresh': { en: 'Refresh', ru: 'Обновить', es: 'Actualizar' },
  'actionLog.loading': { en: 'Loading…', ru: 'Загрузка…', es: 'Cargando…' },
  'actionLog.error': {
  ...
  'actionLog.colTime': { en: 'Time', ru: 'Время', es: 'Hora' },
  'actionLog.colAction': { en: 'Action', ru: 'Действие', es: 'Acción' },
  'actionLog.colResource': { en: 'Resource', ru: 'Ресурс', es: 'Recurso' },
  'actionLog.colDetails': { en: 'Details', ru: 'Детали', es: 'Detalles' },
