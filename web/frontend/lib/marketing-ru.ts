...
export const MARKETING_RU: MarketingStrings = {
  ...
  heroVisualEyebrow: 'Смотрите фабрику в деле',
  heroVisualTitle: 'Идея → агенты → готовый продукт — полный обзор на YouTube',
  heroVisualCaption: 'Демо продукта и тур по пайплайну:',
  heroWatchDemo: 'Открыть на YouTube',
  ...
  logosEyebrow: 'Аналитика федерации · живой продукт',
  logosTitle: 'LOGOS превращает всю экосистему в единую обсерваторию.',
  logosBody:
    'Он опрашивает Hub, MOMUS, SKOPOS и Treasury, сохраняет реальные снимки, находит аномалии по скользящему z-score, связывает сигналы безопасности, задержек, репутации и экономики и отвечает на вопросы через защищённого ассистента.',
  logosReadOnly: 'Read-only по конструкции — не сканирует, не исправляет, не платит и не деплоит',
  logosDashboard: 'Открыть живой LOGOS',
  logosSource: 'Исходный код',
  logosDocs: 'Как работает аналитика',
};
