...
export const MARKETING_ZH: MarketingStrings = {
  ...
  logosEyebrow: '联邦智能 · 在线产品',
  logosTitle: 'LOGOS 将整个生态系统变成一个统一观测站。',
  logosBody:
    '它轮询 Hub、MOMUS、SKOPOS 和 Treasury，保存真实快照，以滚动 z-score 检测异常，关联安全、延迟、声誉与经济信号，并通过受保护的助手回答自然语言问题。',
  logosReadOnly: '架构级只读：从不扫描、修复、付款或部署',
  logosDashboard: '打开在线 LOGOS',
  logosSource: '源代码',
  logosDocs: '分析原理',
};
