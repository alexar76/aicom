...
def refresh_product_storefront_telemetry(
    ...
    *,
    ...
    qa_report = {
        ...
        "quality_gates_all_passed": demo_ok and backend_ok and methodology_ok and tests.get("passed"),
    ...
    (bugs_dir / "qa_report.json").write_text(json.dumps(qa_report, indent=2, ensure_ascii=False), encoding="utf-8")
