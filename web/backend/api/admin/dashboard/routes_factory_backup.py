...
async def download_factory_backup_zip(
    ...
    try:
        ...
        raise HTTPException(status_code=404, detail=client_error_detail(e, fallback="Not found")) from e
    except Exception as e:
        logger.exception("factory backup failed")
        raise HTTPException(status_code=500, detail="Factory backup failed") from e
...
async def factory_restore_preview(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Factory backup operation failed") from e
...
async def factory_restore_execute(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Factory restore failed") from e
