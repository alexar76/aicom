...
def _issue_session(
    ...
    # Additive HttpOnly browser session cookie (SameSite=Strict); mirrors password login.
...
async def oidc_callback(request: Request, code: str = "", state: str = ""):
    ...
    # Constant-time comparison; guard against missing/empty values (compare_digest
    # raises on None and is not constant-time across differing lengths otherwise).
