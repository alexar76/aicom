...
async def get_product(product_id: str):
    ...
    # Populate the product's capabilities from the catalog — the detail endpoint
    # previously always returned [], unlike the list endpoint.
    caps = []
    try:
        from web.backend.services.ai_market_protocol.catalog import list_capabilities
    ...
    return {
        "product": {
            ...
            "tags": p.get("tags") or [],
            "capabilities": caps,
            # pricing/license/quality are reserved for a later protocol version and
            # intentionally empty in v0 (returned empty, never fabricated).
            "pricing": {},
            "license": {},
            "quality": {},
            "crypto_support": {"pilot_enabled": True, **_pilot_config()},
